...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
    ...
    let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "523511617811-523541370478@g.us","inviteCode": "m","groupName": "P", "caption": '𝚃𝚑𝚎- 𝙷𝚊𝚍𝚎𝚜 - 𝙱𝚘𝚝', 'jpegThumbnail': null}}}
